[![Run App Zach Ehlers](https://github.com/zehlers3/GithubActions/actions/workflows/run-app.yaml/badge.svg)] (https://github.com/zehlers3/GithubActions/actions/workflows/run-app.yaml)
